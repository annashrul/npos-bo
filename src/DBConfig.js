  ...
  objectStoresMeta: [
    ...
    },
    {
      ...
      storeSchema: [
        ...
        { name: "lokasi_ktg", keypath: "lokasi_ktg", options: { unique: false } },
        { name: "nama_toko", keypath: "nama_toko", options: { unique: false } },
        { name: "phone", keypath: "phone", options: { unique: false } },
        { name: "serial", keypath: "serial", options: { unique: false } },
        { name: "status", keypath: "status", options: { unique: false } },
        { name: "status_show", keypath: "status_show", options: { unique: false } },
        { name: "totalrecords", keypath: "totalrecords", options: { unique: false } },

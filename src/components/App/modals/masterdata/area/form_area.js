...
import {createArea, updateArea} from "redux/actions/masterdata/area/area.action";
...
class FormArea extends Component{
    ...
    handleSubmit(e){
        ...
        parseData['gambar'] = this.state.gambar === undefined?'-':this.state.gambar.base64;
                    ...
                    <ModalBody>
                        ...
                        <div className="form-group">
                            ...
                            <FileBase64
                                ...
                                <div className="invalid-feedback"
                                    style={this.state.error.gambar !== "" ? {display: 'block'} : {display: 'none'}}>

...
class FormSupplier extends Component{
    constructor(props){
        ...
        this.state = {
            kode:'', nama:'',alamat:'',kota:'',telp:'',penanggung_jawab:'',no_penanggung_jawab:'',status:'',email:'',
            error:{kode:'', nama:'',alamat:'',kota:'',telp:'',penanggung_jawab:'',no_penanggung_jawab:'',status:'',email:''}
        };
    }
    getProps(param){
    ...
    handleSubmit(e){
        ...
        else if(parseData['penanggung_jawab']===''||parseData['penanggung_jawab']===undefined){
            err = Object.assign({}, err, {penanggung_jawab:"penanggung jawab tidak boleh kosong"});
            this.setState({error: err});
        }
        else if(parseData['no_penanggung_jawab']===''||parseData['no_penanggung_jawab']===undefined){
            err = Object.assign({}, err, {no_penanggung_jawab:"no penanggung jawab tidak boleh kosong"});
            this.setState({error: err});
        }
                        ...
                        <div className="row">
                            <div className="col-6">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="invalid-feedback"
                                         style={this.state.error.alamat !== "" ? {display: 'block'} : {display: 'none'}}>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="invalid-feedback"
                                         style={this.state.error.kota !== "" ? {display: 'block'} : {display: 'none'}}>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="invalid-feedback"
                                         style={this.state.error.telp !== "" ? {display: 'block'} : {display: 'none'}}>
                            ...
                            <div className="col-6">
                                <div className="form-group">
                                    ...
                                    <div className="invalid-feedback"
                                         style={this.state.error.penanggung_jawab !== "" ? {display: 'block'} : {display: 'none'}}>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="invalid-feedback"
                                         style={this.state.error.no_penanggung_jawab !== "" ? {display: 'block'} : {display: 'none'}}>

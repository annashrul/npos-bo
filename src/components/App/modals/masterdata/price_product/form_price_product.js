    ...
    if (parseData["harga"] === "" || parseData["harga"] === undefined) {
      ...
      if (parseInt(parseData["harga"], 10) < 0) {
        err = Object.assign({}, err, {
          harga: "harga 1 tidak boleh kurang dari 0",
        });
        this.setState({ error: err });
      } else if (parseInt(parseData["harga2"], 10) < 0) {
        err = Object.assign({}, err, {
          harga2: "harga 2 tidak boleh kurang dari 0",
        });
        this.setState({ error: err });
      } else if (parseInt(parseData["harga3"], 10) < 0) {
        err = Object.assign({}, err, {
          harga3: "harga 3 tidak boleh kurang dari 0",
        });
        this.setState({ error: err });
      } else if (parseInt(parseData["harga4"], 10) < 0) {
        err = Object.assign({}, err, {
          harga4: "harga 4 tidak boleh kurang dari 0",
        });
        this.setState({ error: err });
        ...
        err = Object.assign({}, err, {
          service: "service tidak boleh kurang dari 0",
        });
        this.setState({ error: err });
      } else {
        this.props.dispatch(
    ...
    return (
      ...
      >
        <ModalHeader toggle={this.toggle}>
          {this.props.detail === undefined ? "" : "Ubah Harga Barang"}
        </ModalHeader>

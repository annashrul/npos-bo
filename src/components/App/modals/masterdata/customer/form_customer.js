...
class FormCustomer extends Component {
  ...
  getProps(param) {
    ...
    if (
      param.dataCustomerEdit !== undefined &&
      param.dataCustomerEdit.length !== 0
    ) {
      this.setState({
        ...
        tgl_ultah: moment(param.dataCustomerEdit.tgl_ultah).format(
          "yyyy-MM-DD"
        ),
  ...
  handleSubmit(e) {
    ...
    if (parseData["nama"] === "" || parseData["nama"] === undefined) {
      ...
      parseData["cust_type"] === "" ||
      parseData["cust_type"] === undefined
    ) {
      err = Object.assign({}, err, {
        cust_type: "tipe customer tidak boleh kosong",
      });
      this.setState({ error: err });
    } else if (
      parseData["jenis_kelamin"] === "" ||
      parseData["jenis_kelamin"] === undefined
    ) {
      err = Object.assign({}, err, {
      ...
      parseData["tgl_ultah"] === "" ||
      parseData["tgl_ultah"] === undefined
    ) {
      err = Object.assign({}, err, {
        tgl_ultah: "tanggal ulang tahun tidak boleh kosong",
      });
      this.setState({ error: err });
    } else if (
      parseData["status"] === "" ||
    ...
    // }
      ...
      if (this.props.dataCustomerEdit !== undefined) {
        this.props.dispatch(
          updateCustomer(this.props.dataCustomerEdit.kd_cust, parseData)
        );
        this.props.dispatch(ModalToggle(false));
      } else {
        if (
          parseData["password"] === "" ||
          parseData["password"] === undefined
        ) {
          err = Object.assign({}, err, {
              ...
              <div className="col-6">
                ...
                <div className="form-group">
                  ...
                  <Select
                    ...
                    value={this.state.location_data.find((lk) => {
                ...
                <div className="form-group">
                  ...
                  <Select
                    ...
                    value={this.state.cust_type_data.find((op) => {

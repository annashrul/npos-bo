...
import {DropdownItem, DropdownMenu, DropdownToggle, ModalBody, ModalHeader, UncontrolledButtonDropdown} from "reactstrap";
...
class DetailSaleByProductReport extends Component{
    ...
    handleExport(e,total){
        ...
        this.props.dispatch(FetchPiutangReportDetail(kode,1,dateFrom===null?this.props.startDate:dateFrom,dateTo===null?this.props.endDate:dateTo,total));
    }
    ...
    render(){
        ...
        const {data,last_page, per_page,current_page} = this.props.piutangReportDetail;
                    ...
                    <table className="table" >
                        <tbody className="bg-transparent no-border" style={{border:"none"}}>
                            <tr>
                                ...
                                <th className="text-black" style={centerStyle}>Jumlah Piutang</th>
                            ...
                            <tr>
                                ...
                                <th className="text-black" style={centerStyle}>{toRp(parseInt(this.props.detail.jml_piutang,10))}</th>
                    ...
                    <div style={{overflowX: "auto"}}>
                        <table className="table table-hover table-bordered">
                            ...
                            <tr>                            
                                ...
                                <th className="text-black" style={centerStyle}>Cara Bayar</th>
                                                    ...
                                                    <div className="btn-group">
                                                        <UncontrolledButtonDropdown>
                                                            ...
                                                            <DropdownMenu>
                                                                ...
                                                                <Link to={`../bayar_piutang3ply/${v.no_nota}|${this.props.detail.id}`}><DropdownItem>3ply</DropdownItem></Link>
                                                            </DropdownMenu>
                                                            </UncontrolledButtonDropdown>
                                                    </div>
                                                </td>
                            ...
                            <table className="table table-hover table-bordered" id="laporan_product_detail" style={{display:'none'}}>
                                <thead className="bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Faktur Jual</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Tanggal Bayar</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Cara Bayar</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Jumlah</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">nama Bank</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Jatuh Tempo</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">No Giro</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Tanggal Cair Giro</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Nama</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">kode Cust.</th>
                                        <th className="text-black" style={ centerStyle} rowSpan="2">Keterangan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                {
                                        ...
                                        data.map((v,i)=>{
                                            return (
                                                <tr key={i}>
                                                    ...
                                                    <td style={centerStyle}>{v.no_nota}</td>
                                                    <td style={centerStyle}>{v.fak_jual}</td>
                                                    <td style={centerStyle}>{moment(v.tgl_byr).format("DD-MM-YYYY")}</td>
                                                    <td style={centerStyle}>{v.cara_byr}</td>
                                                    <td style={centerStyle}>{v.jumlah}</td>
                                                    <td style={centerStyle}>{v.nm_bank}</td>
                                                    <td style={centerStyle}>{moment(v.tgl_jatuh_tempo).format("DD-MM-YYYY")}</td>
                                                    <td style={centerStyle}>{v.nogiro}</td>
                                                    <td style={centerStyle}>{moment(v.tgl_cair_giro).format("DD-MM-YYYY")}</td>
                                                    <td style={centerStyle}>{v.nama}</td>
                                                    <td style={centerStyle}>{v.kd_cust}</td>
                                                    <td style={centerStyle}>{v.ket}</td>
                                                </tr>

...
class DetailSaleByProductReport extends Component{
    ...
    handleExport(e,total){
        ...
        this.props.dispatch(FetchHutangReportDetail(kode,1,dateFrom===null?this.props.startDate:dateFrom,dateTo===null?this.props.endDate:dateTo,total));
    }
                                                    ...
                                                    <div className="btn-group">
                                                        <UncontrolledButtonDropdown>
                                                            ...
                                                            <DropdownMenu>
                                                                ...
                                                                <Link to={`../bayar_hutang3ply/${v.no_nota}|${this.props.detail.id}`}><DropdownItem>3ply</DropdownItem></Link>
                                                            </DropdownMenu>
                                                            </UncontrolledButtonDropdown>
                                                    </div>
                                                </td>

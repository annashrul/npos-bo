...
import { float, handleError, lengthBrg, noData, setFocus, toDate } from "../../../../../../helper";
...
class FormReturReceive extends Component {
  ...
  render() {
    ...
    return (
      <WrapperModal isOpen={this.props.isOpen && this.props.type === "formReturReceive"} size="lg">
                ...
                ? this.state.data_retur.map((v, i) => {
                    ...
                    return (
                      <tr key={i}>
                        ...
                        <td className="middle nowrap">
                          <select className="form-control in-table" style={{ width: "140px" }} name="kondisi" onChange={(e) => this.HandleChangeInputValue(e, i)} value={v.kondisi}>
                        ...
                        <td className="middle nowrap">
                          <input disabled={true} type="text" className="form-control in-table text-right" value={toRp(parseFloat(v.qty_retur) * parseFloat(v.harga_beli))} />
                        </td>
                      </tr>
                    );
                  })

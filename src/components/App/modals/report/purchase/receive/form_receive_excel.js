...
class ReceiveReportExcel extends Component {
  ...
  printDocument = (e) => {
    ...
    const headers = [["No Faktur", "Tanggal", "Penerima", "Tipe", "Pelunasan", "Diskon", "PPN", "Supplier", "Operator", "Lokasi", "Serial", "Kontrabon", "Jumlah Kontabon", "Qty Beli", "Total Beli"]];
    let data =
      typeof this.props.receiveReportExcel.data === "object"
        ? this.props.receiveReportExcel.data.map((v) => [
            v.no_faktur_beli,
  ...
  printDocumentXLsx = (e, param) => {
    ...
    let header = [
      ...
      [""],
      ["No Faktur", "Tanggal", "Penerima", "Tipe", "Pelunasan", "Diskon", "PPN", "Supplier", "Operator", "Lokasi", "Serial", "Pembayaran ke-", "Sisa Pembayaran", "Qty Beli", "Total Beli"],
    ];
    let footer = [
  ...
  render() {
    return (
      <WrapperModal
        isOpen={this.props.isOpen && this.props.type === "formReceiveExcel"}

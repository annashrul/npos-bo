...
class DetailDn extends Component{
    ...
    render(){
        ...
        return (
            <div>
                <WrapperModal isOpen={this.props.isOpen && this.props.type === "detailDn"} size="lg" style={{maxWidth: '1600px', width: '100%'}}>
                    <ModalHeader toggle={this.toggle}>Detail Dn</ModalHeader>
                    <ModalBody>

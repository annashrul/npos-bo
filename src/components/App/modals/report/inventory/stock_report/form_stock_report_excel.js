...
class StockReportExcel extends Component {
  ...
  printDocument = (e) => {
    ...
    const headers = [["Kd Cust", "Nama", "Gross Sales", "Diskon Item", "Diskon Trx", "Service", "Qty"]];
    let data =
      typeof this.props.sale_by_custReportExcel.data === "object"
        ? this.props.sale_by_custReportExcel.data.map((v) => [
            v.kd_cust,
            v.nama,
  ...
  printDocumentXLsx = (e, param) => {
    ...
    let header = [
      ...
      [""],
      ["Kode Barang", "Barcode", "Satuan", "Nama", "Supplier", "Sub Dept", "Kelompok", "DN", "Stock Awal", "Stock In", "Stock Out", "Stock Sale", "Stock Akhir"],
    ];
    let footer = [
    ...
    let raw =
      typeof this.props.stockReportExcel.data === "object"
        ? this.props.stockReportExcel.data.map((v) => [
            v.kd_brg,
            v.barcode,
            v.satuan,
            v.nm_brg,
            ...
            <ModalBody>
              ...
              <div className="row mb-4">
                ...
                <div className="col-6">
                  <div className="single-gallery--item">
                    ...
                    <div className="gallery-text-area">
                      <div className="gallery-icon">
                        <button type="button" className="btn btn-circle btn-lg btn-success" onClick={(e) => this.printDocumentXLsx(e, "csv")}>
                          <i className="fa fa-print"></i>
                        </button>
                      </div>
                    </div>
              ...
              <table className="table table-hover table-bordered table-responsive" id="laporan_sale_by_cust" style={{ display: this.state.view === false ? "none" : "inline-table" }}>
                <thead className="bg-light">
                  <tr>
                    <th className="text-black" colSpan={12}>
                  ...
                  <tr>
                    ...
                    <th className="text-black" colSpan="4" style={columnStyle}>
                      Stok
                    </th>
                  </tr>
                  <tr>
                    <th className="text-black" rowSpan="1" style={columnStyle}>
                      Awal
                    </th>
                    <th className="text-black" rowSpan="1" style={columnStyle}>
                      Masuk
                ...
                </thead>
                {
                  <tbody>
                    {typeof this.props.stockReportExcel.data === "object"
                      ? this.props.stockReportExcel.data.length > 0
                    ...
                    <tfoot>
                      ...
                      <tr style={{ fontWeight: "bold", backgroundColor: "#EEEEEE" }}>
                        ...
                        <th colSpan="1" style={{ textAlign: "right" }}>
                          {total_dn !== undefined ? total_dn : "0"}
                        </th>
                        <th colSpan="1" style={{ textAlign: "right" }}>
                          {total_stock_awal === undefined ? 0 : total_stock_awal}
                        </th>
                        <th colSpan="1" style={{ textAlign: "right" }}>
                          {total_stock_masuk === undefined ? 0 : total_stock_masuk}
                        </th>
                        <th colSpan="1" style={{ textAlign: "right" }}>
                          {total_stock_keluar === undefined ? 0 : total_stock_keluar}
                        </th>
                        <th colSpan="1" style={{ textAlign: "right" }}>
                          {total_stock_akhir === undefined ? 0 : total_stock_akhir}
                        </th>
                      </tr>
                    </tfoot>
                  </tbody>

...
class DetailTransaction extends Component {
  ...
  render() {
    const { per_page, current_page, data, total } = this.props.transactionDetail.detail === undefined ? [] : this.props.transactionDetail.detail;
    const master = this.props.transactionDetail === undefined ? [] : this.props.transactionDetail;
    const head = [
          ...
          <ModalBody>
            <HeaderDetailCommon
              data={[
                ...
                { title: "Status penerimaan", desc: statusMutasi(master.status) },
                { title: "Faktur beli", desc: rmSpaceToStrip(master.no_faktur_beli) },
                { title: "Status pembayaran", desc: statusArsipPenjualan(`${master.status_transaksi}`) },

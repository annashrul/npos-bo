...
class PackingReportExcel extends Component{
    ...
    printDocument = (e) => {
        ...
        let data = typeof this.props.packingReportExcel.data === 'object'?this.props.packingReportExcel.data.map(v=> [
           v.kd_packing,
           ...
           v.nama_operator,
           v.status==='0'?'Belum Packing':(v.status==='1'?'Sudah Packing':""),
        ]):'';
        // data +=["TOTAL","","","","","","","","",tprice];
        to_pdf(
            "packing_",
    ...
    render(){
        ...
        return (
            <WrapperModal isOpen={this.props.isOpen && this.props.type === "formPackingExcel"} size={this.state.view === false?'md':'xl'} aria-labelledby="contained-modal-title-vcenter" centered keyboard>
                ...
                <form onSubmit={this.handleSubmit}>
                    <ModalBody>
                        ...
                        {/* <hr></hr> */}
                        <table className="table table-hover table-bordered table-responsive"  id="laporan_packing" style={{display:this.state.view === false?'none':'inline-table'}}>

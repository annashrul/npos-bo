        ...
        <form onSubmit={this.handleSubmit}>
          <ModalBody>
            <div className="form-group">
              <label>Jumlah</label>
              <input type="text" className="form-control" name="jumlah" value={toCurrency(this.state.jumlah)} onChange={this.handleChange} />
              <div className="invalid-feedback" style={this.state.error.jumlah !== "" ? { display: "block" } : { display: "none" }}>
            ...
            <div className="form-group">
              ...
              <div className="invalid-feedback" style={this.state.error.keterangan !== "" ? { display: "block" } : { display: "none" }}>

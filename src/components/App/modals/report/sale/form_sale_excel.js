...
class SaleReportExcel extends Component {
  ...
  printDocument = (e) => {
    ...
    let data =
      typeof this.props.saleReportExcel.data === "object"
  ...
  printDocumentXLsx = (e, param) => {
    ...
    let exportFileName = `Laporan_Penjualan_${moment(new Date()).format(
      "YYYYMMDDHHMMss"
    )}.${param === "csv" ? `csv` : `xlsx`}`;
  ...
  render() {
    ...
    return (
      <WrapperModal
        isOpen={this.props.isOpen && this.props.type === "formSaleExcel"}
      ...
      >
        ...
        <form onSubmit={this.handleSubmit}>
          {!this.props.isLoadingReport ? (
                    ...
                    <div className="gallery-text-area">
                      <div className="gallery-icon">
                        <button
                          type="button"
                          className="btn btn-circle btn-lg btn-success"
                          onClick={(e) => this.printDocumentXLsx(e, "csv")}
                        >
                          <i className="fa fa-print"></i>
                        </button>
                      </div>
            ...
            <Spinner
              spinnerLabel={`Sedang memuat data sebanyak ${this.props.totalRow} ...`}
            />
          )}
        </form>
      </WrapperModal>

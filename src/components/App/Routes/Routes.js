...
import Printer from "../masterdata/printer";
  ...
  <div>
    <Switch>
      ...
      <PrivateRoute
        ...
        exact
        strict
        component={ApprovalMutasiJualBeli}
      />
      <PrivateRoute
        path="/bayar_mutasi_jual_beli"
        exact
        strict
        component={BayarMutasiJualBeli}
      />
      ...
      />
      <PrivateRoute
        path="/report/sale_by_sales_archive"
        exact
        strict

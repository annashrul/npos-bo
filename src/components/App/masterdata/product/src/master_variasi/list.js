...
class ListVariasiProduct extends Component {
  constructor(props) {
    super(props);
  ...
  handleDelete(i) {
    this.props.dispatch(
      deleteGroupProduct(this.props.data.data[i].kel_brg, this.state.where)
    );
  }
  render() {
...
export default connect(mapStateToProps)(ListVariasiProduct);

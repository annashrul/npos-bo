            ...
            <div className="col-10 col-xs-10 col-md-3">
              <div className="input-group input-group-sm">
                <input
                  ...
                  placeholder="Search"
                  defaultValue={localStorage.getItem("any_group_product")}
                />
        ...
        <div style={{ overflowX: "auto" }}>
          <table className="table table-hover table-noborder">
            <thead className="bg-light">
              <tr>
                <th className="text-black" style={{ width: "1%" }}>
                  #
                </th>
                <th className="text-black middle">Kode</th>
                <th className="text-black middle">Nama</th>
                <th className="text-black middle">Sub Dept</th>
                <th className="text-black middle">Status</th>
                <th className="text-black middle">Gambar</th>
              </tr>
            </thead>
            <tbody>
              {typeof data === "object"
                ? data.map((v, i) => {
                    return (
                      <tr key={i}>
                        ...
                        <td className="middle">{v.kel_brg}</td>
                        <td className="middle">{v.nm_kel_brg}</td>
                        <td className="middle">{v.group2}</td>
                        <td className="middle">
                          {v.status === "1"

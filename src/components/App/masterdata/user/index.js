          ...
          <div className="card">
            <Tabs>
              ...
              <div className="card-body">
                <TabPanel>{!this.props.isLoading ? <ListUserList token={this.state.token} userListData={this.props.userlist} pagin={this.handlePagin} /> : <Preloader />}</TabPanel>
                <TabPanel>
                  {!this.props.isLoading1 ? <ListUserLevel token={this.state.token} data={this.props.userLevel} pagin={this.handlePagin} /> : <Preloader />}
                  {/*<MasterUserLevel/>*/}
                </TabPanel>
              </div>
            </Tabs>

...
import { deleteUserList, FetchUserListDetail, FetchUserListEdit, setUserListEdit, getUserList } from "redux/actions/masterdata/user_list/user_list.action";
  ...
  render() {
    ...
    return (
      <div>
                            ...
                            <UncontrolledButtonDropdown>
                              ...
                              <DropdownMenu>
                                ...
                                {this.props.auth.user.is_public !== 1 ? (
                                  <DropdownItem onClick={(e) => this.props.dispatch(deleteUserList(v.id))}>
        ...
        {this.state.isModalForm && this.props.isOpen ? <FormUserList lokasi={this.props.lokasi} userLevel={this.props.userLevel} userListEdit={this.props.userListEdit} /> : null}

        {this.state.isModalFormPrompt && this.props.isOpen ? <FormUserListPrompt token={this.props.token} /> : null}
        {this.state.isModalDetail && this.props.isOpen ? <DetailUserList userListDetail={this.props.userListDetail} lokasi={this.props.lokasi} /> : null}
      </div>
    );
  }
}

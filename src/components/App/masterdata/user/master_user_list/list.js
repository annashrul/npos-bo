...
import { deleteUserList, FetchUserList, FetchUserListDetail, FetchUserListEdit, setUserListEdit } from "redux/actions/masterdata/user_list/user_list.action";
  ...
  render() {
    ...
    return (
      <div>
          ...
          <div className="row">
            ...
            <div className="col-2 col-xs-2 col-md-3">
              <div className="form-group">
                ...
                <button style={{ marginTop: "27px", marginLeft: "2px" }} type="button" className="btn btn-primary" onClick={(e) => this.toggleModal(e)}>
                        ...
                        <div className="d-flex justify-content-between mb-2 pb-2">
                          ...
                          <div className="dashboard-dropdown">
                            <UncontrolledButtonDropdown>
                              ...
                              <DropdownMenu>
                                <DropdownItem onClick={(e) => this.toggleEdit(e, v.id)}>
                                  <i className="ti-pencil-alt"></i> Edit
                                </DropdownItem>
                                <DropdownItem onClick={(e) => this.handleDetail(e, v.id)}>
                                  <i className="ti-eye"></i> Detail
                                </DropdownItem>
                                {this.props.auth.user.is_public !== 1 ? (
                                  <DropdownItem onClick={(e) => this.handleDelete(e, v.id)}>
        ...
        <FormUserList token={this.props.token} lokasi={this.props.lokasi} userLevel={this.props.userLevel} userListEdit={this.props.userListEdit} />

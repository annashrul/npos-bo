    ...
    render(){
        ...
        return(
            <li className={`treeview ${this.props.isActive?" active menu-open":""}`}  style={{display:this.props.isDisplay?'block':'none'}}>
                <a href="#" onClick={(e) => this.changeMenu(e,this.props.arg1,this.props.arg2)}><i className={`${this.props.icon}`}/> <span>{this.props.label}</span> <i className="fa fa-angle-right" /></a>

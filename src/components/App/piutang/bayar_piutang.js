    ...
    render(){
        ...
        return (
            <Layout page="Bayar Piutang">
                <Card>
                    <CardHeader className="bg-transparent d-flex align-items-center justify-content-between"><h4>Pembayaran Piutang</h4><h4>Total Piutang Rp. {toRp(parseInt(total_piutang,10))}</h4></CardHeader>

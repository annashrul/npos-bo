                    ...
                    <table width="99%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th style={{paddingRight: '5pt'}} className="text-right">{toRp(master.st)}</th>
                            </tr>
                            <tr>
                                <th colSpan={4}> </th>
                                <th className="kanan">Diskon Rp.</th>
                                <th style={{paddingRight: '5pt'}} className="text-right">{toRp(master.dis_rp)}</th>
                            </tr>
                            <tr>
                                <th colSpan={4}> </th>
                                <th className="kanan">Pajak Rp.</th>
                                <th style={{paddingRight: '5pt'}} className="text-right">{toRp((parseInt(master.st,10)*master.tax/100))}</th>
                            </tr>
                            <tr>
                                <th colSpan={4}> </th>
                                <th className="kanan">Grand Total Rp.</th>
                                <th style={{paddingRight: '5pt'}} className="text-right">{toRp(master.gt)}</th>
                            </tr>
                        </tbody></table>

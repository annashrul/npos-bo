  ...
  handleLoadMore() {
    ...
    if (perpage === lengthBrg || perpage < lengthBrg) {
      ...
      if (this.getConfigSupplier() === 0) {
        ...
        this.props.dispatch(
          FetchBrg(1, searchby, localStorage.anyPurchaseOrder !== undefined ? localStorage.anyPurchaseOrder : "", this.state.location, this.state.supplier, this.autoSetQty, this.state.perpage)
        );
      }
                  ...
                  <div className="form-group">
                    <div className="input-group input-group-sm">
                      <input
                        ...
                        placeholder={`Search ${localStorage.anyPurchaseOrder !== undefined ? localStorage.anyPurchaseOrder : ""}`}
                        ...
                        <ul className="chat-list list-unstyled">
                          {this.props.barang && this.props.barang.length !== 0 ? (
                            this.props.barang.map((i, inx) => {
                              return (
                                <li
                                  style={{ backgroundColor: this.state.scrollPage === inx ? "#eeeeee" : "" }}
                                  id={`item${inx}`}
                                  className="clearfix"
                                  key={inx}
                                  onClick={(e) =>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              <label className="control-label font-12">Tanggal Kirim</label>
                          ...
                          <div className="col-md-12">
                            <div className="row">
                              <div className="col-md-12" style={{ marginTop: atob(atob(Cookies.get("tnt="))) === "rb" || atob(atob(Cookies.get("tnt="))) === "npos" ? "-10px" : "0px" }}>
                              ...
                              <div
                                className="col-md-12"
                                style={{ marginTop: "-15px", display: atob(atob(Cookies.get("tnt="))) === "rb" || atob(atob(Cookies.get("tnt="))) === "npos" ? "block" : "none" }}
                              >
                                <div className="form-group">
                                  <input
                                    type="checkbox"
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <textarea name={"catatan"} className="form-control" onChange={(e) => this.HandleCommonInputChange(e)} style={{ height: "122px" }}>
                            {this.state.catatan}
                          </textarea>
                        </div>
                      </div>

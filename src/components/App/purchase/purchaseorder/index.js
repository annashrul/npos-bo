...
class PurchaseOrder extends Component {
  ...
  HandleSubmit(e) {
    ...
    if (this.state.catatan === "" || this.state.location === "" || this.state.supplier === "") {
      ...
      data.then((res) => {
        if (res.length === 0) {
          Swal.fire("Error!", "Pilih barang untuk melanjutkan PO.", "error");
        } else {
          Swal.fire({
            allowOutsideClick: false,
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <a href="about:blank" onClick={(e) => this.HandleSubmit(e)} className="btn btn-primary ml-1">
                        Simpan
                      </a>
                      <a href="about:blank" onClick={(e) => this.HandleReset(e)} className="btn btn-danger ml-1">
                        Reset
                      </a>
                    </div>
                  </div>

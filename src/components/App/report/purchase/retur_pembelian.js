...
class ReturPembelianReport extends Component {
  ...
  render() {
    const { per_page, last_page, current_page, data, total } = this.props.data;
    ...
    return (
      <Layout page="Laporan Retur Pembelian">
        ...
        />
        {this.props.isOpen && isModalDetail ? <DetailReportRetur startDate={startDate} endDate={endDate} /> : null}
      </Layout>
    );
  }
}

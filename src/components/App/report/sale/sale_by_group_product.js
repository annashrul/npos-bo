...
import { FetchSaleByGroupProduct,FetchSaleByGroupProductExport} from "../../../../redux/actions/sale/sale_by_group_product.action";
...
class SaleByGroupProduct extends Component {
  ...
  handleModal(param = "detail", index, total = 0) {
    ...
    if (param === "excel") {
      ...
      // this.props.dispatch(ModalType("detailSaleByGroupProductReport"));

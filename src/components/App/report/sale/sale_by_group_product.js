...
import { FetchSaleByGroupProduct,FetchSaleByGroupProductExport,FetchReportDetailSaleByProduct} from "../../../../redux/actions/sale/sale_by_group_product.action";
...
import { generateNo, getFetchWhere, getPeriode, noData, parseToRp, rmSpaceToStrip, rmToZero } from "../../../../helper";
    ...
    render() {
        ...
        return (
            <Layout page="Laporan penjualan by kelompok barang">
                ...
                />
                {this.props.isOpen && isModalExport ? <ModalSaleByGroupProduct startDate={startDate} endDate={endDate} /> : null}
                {this.props.isOpen && isModalDetail ? <DetailSaleByGroupProduct data={this.props.dataDetail} detail={detail} /> : null}
            </Layout>
        );
    }
}

...
class SideMenu extends Component {
    constructor(props){
        ...
        this.state ={
            ...
            aksesUser:[],
            arrState:[
                {temp:1,parent:1,range1:0,range2:10,label:'masterdata',display:'isMasterdataDisplay',state:'isMasterdata'},
                {temp:1,parent:2,range1:10,range2:20,label:'inventory',display:'isInventoryDisplay',state:'isInventory'},
                {temp:0,parent:7,range1:30,range2:40,label:'produksi',display:'isProductionDisplay',state:'isProduction'},
                {temp:1,parent:3,range1:40,range2:50,label:'pembelian',display:'isReceiveDisplay',state:'isReceive'},
                {temp:1,parent:4,range1:50,range2:60,label:'transaksi',display:'isSaleDisplay',state:'isSale'},
                {temp:1,parent:5,range1:60,range2:70,label:'pembayaran',display:'isPaidDisplay',state:'isPaid'},
                {temp:2,parent:6,range1:70,range2:100,label:'laporan',display:'isReportDisplay',state:'isReport',data:[
                ...
                {temp:1,parent:0,range1:1100,range2:120,label:'setting',display:'isSettingDisplay',state:'isSetting'},
            ],
            isLoading:true,

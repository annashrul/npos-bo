...
export const menuTransaksi = [
  { id: 42, value: "0", isChecked: false, label: "Sales Order" },
...
export const menuReport = [
  ...
  { id: 84, value: "0", isChecked: false, label: "Penjualan By Barang" },
  { id: 85, value: "0", isChecked: false, label: "Penjualan By Kel.Barang" },
];

export const menuProduksi = [
